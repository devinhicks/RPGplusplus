...
public class PlayerController : MonoBehaviourPun
{
    ...
    {
        if (collision.gameObject.transform.parent.name == "Death")
        {
            Die();
        }
        else if (collision.gameObject.transform.parent.name == "Secret Stairs")
        {
            Teleport(collision.gameObject.name);
        }
        else if (collision.gameObject.transform.parent.name == "Potion")
        {
            invincible = true;
        }
    }
    ...
    public void Teleport(string name)
    {
        ...
        {
            case "left1":
                spawnPos = GameObject.FindGameObjectWithTag("left2").transform.position;
                break;
            case "right0":
                spawnPos = GameObject.FindGameObjectWithTag("right2").transform.position;
                break;
            case "right1":
                spawnPos = GameObject.FindGameObjectWithTag("right2").transform.position;
                break;
